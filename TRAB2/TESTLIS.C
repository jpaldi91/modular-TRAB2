   ...
   TST_tpCondRet TST_EfetuarComando( char * ComandoTeste )
   {
      ...
      /* Testar CriarLista */
         ...
         else if ( strcmp( ComandoTeste , CRIAR_LISTA_CMD ) == 0 )
         {
			...
			CondRet = LIS_CriarLista( &vtListas[ inxLista ] ) ;
      ...
      /* Testar inserir elemento antes */
         ...
         else if ( strcmp( ComandoTeste , INS_ELEM_ANTES_CMD ) == 0 )
         {
			...
			CondRet = LIS_InserirElementoAntes( vtListas[ inxLista ], &vetDado[inxDado]);
      ...
      /* Testar inserir elemento apos */
         ...
         else if ( strcmp( ComandoTeste , INS_ELEM_APOS_CMD ) == 0 )
         {
            ...
            CondRet = LIS_InserirElementoApos( vtListas[ inxLista ] , &vetDado[inxDado] ) ;
      ...
      /* Testar obter valor do elemento corrente */
         ...
         else if ( strcmp( ComandoTeste , OBTER_VALOR_CMD ) == 0 )
         {
			...
			CondRet = LIS_ObterValor( vtListas[ inxLista ], &EndObtido );
      ...
      /* Testar ir para o elemento inicial */
         ...
         else if ( strcmp( ComandoTeste , IR_INICIO_CMD ) == 0 )
         {
            ...
            CondRet = IrInicioLista( vtListas[ inxLista ] ) ;

            return TST_CompararInt( ValEsp, CondRet, "Retorno inesperado." ) ;
      ...
      /* LIS  &Ir para o elemento final */
         ...
         else if ( strcmp( ComandoTeste , IR_FIM_CMD ) == 0 )
         {
            ...
            CondRet = IrFinalLista( vtListas[ inxLista ] ) ;
